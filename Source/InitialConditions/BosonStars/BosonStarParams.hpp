...
struct BosonStar_params_t
{
    ...
    bool BS_enable_matching; // whether to enable macthing to asymptotic expressions 
    ...
    bool antiboson; // whether one star should have an oppositive frequency to its companion in a binary
    ...
    int conformal_factor_power; // power for the conformal factor expression in the unequal-mass fix 
