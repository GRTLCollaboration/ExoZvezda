...
#ifndef BBSPLAINSUPERPOSITIONLEVEL_HPP_
#define BBSPLAINSUPERPOSITIONLEVEL_HPP_
...
*/
class BBSPlainSuperpositionLevel : public GRAMRLevel
{
    friend class DefaultLevelFactory<BBSPlainSuperpositionLevel>;
...
#endif /* BBSPLAINSUPERPOSITIONLEVEL_HPP_ */
