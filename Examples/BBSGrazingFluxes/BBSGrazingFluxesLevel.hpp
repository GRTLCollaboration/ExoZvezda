...
#ifndef BBSGRAZINGFLUXESLEVEL_HPP_
#define BBSEGRAZINGFLUXESLEVEL_HPP_
...
*/
class BBSGrazingFluxesLevel : public GRAMRLevel
{
    friend class DefaultLevelFactory<BBSGrazingFluxesLevel>;
...
#endif /* BBSGRAZINGFLUXESLEVEL_HPP_ */
