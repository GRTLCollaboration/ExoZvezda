...
class SimulationParameters : public SimulationParametersBase
{
  public:
    ...
    void readParams(GRParmParse &pp)
    {
        ...
        // Flux extraction 
        pp.load("flux_extraction_level", angmomflux_params.extraction_levels, 0);
        pp.load("flux_number_of_radii", angmomflux_params.num_extraction_radii, 1);
        ...
        pp.load("flux_extraction_center", angmomflux_params.extraction_center,
                                                center);
        pp.load("flux_extraction_radii", angmomflux_params.extraction_radii, angmomflux_params.num_extraction_radii, 0.1);
